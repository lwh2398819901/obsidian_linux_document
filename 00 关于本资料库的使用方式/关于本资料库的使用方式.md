...
```
推荐使用插件[[关于本资料库的使用方式#convert-url-to-iframe|convert-url-to-iframe]]
...
网页端推荐使用[[【all】油猴插件#HTML5视频播放器增强脚本]]，pc端推荐使用[[【other】其他#vlc]]

> document.querySelector('video').playbackRate = 3

### ~~获取b站视频列表方式~~ (不推荐了 并不是多好用 )
...
###  Execute Code
[twibiral/obsidian-execute-code: Obsidian Plugin to execute code in a note. --- twibiral/obsidian-execute-code：黑曜石插件，用于执行笔记中的代码。 (github.com)](https://github.com/twibiral/obsidian-execute-code)
![[1701668157424.png]]
